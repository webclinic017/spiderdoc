...
while True:
    ...
    os.system(" docker run -v /appcode/output/positions:/outfile/position backtest:1.0.0 "+line1+' '+start_date_range+' '+end_date_range+' '+run_type)
    line2 = f.readline()
    if not line2: break
    ...
    os.system(" docker run -v /appcode/output/positions:/outfile/position backtest:1.0.0 "+line2+' '+start_date_range+' '+end_date_range+' '+run_type)
    line3 = f.readline()
    if not line3: break
    ...
    os.system(" docker run -v /appcode/output/positions:/outfile/position backtest:1.0.0 "+line3+' '+start_date_range+' '+end_date_range+' '+run_type)
    line4 = f.readline()
    if not line4: break
    ...
    os.system(" docker run -v /appcode/output/positions:/outfile/position backtest:1.0.0 "+line4+' '+start_date_range+' '+end_date_range+' '+run_type)
