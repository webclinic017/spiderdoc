...
def start_container (symbols_file):
    ...
    subprocess.call(["docker", "run", "-v","/containers/output:/output", "ROC_BT:1.0.0", symbols_file,start_date_range,end_date_range,run_type,prallel_proc_amnt])
...
subprocess.call(["docker","build","-t", "ROC_BT:1.0.0", "/appcode/spiderdoc/BT/containers/ROC_1/."])
